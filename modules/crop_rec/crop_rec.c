...
static int max_resolutions[NUM_CROP_PRESETS][6] = {
    ...
    [CROP_PRESET_3x3_1X_48p]    = { 1290, 1290, 1290, 1040, 1040, 800 }, /* 1080p45/48 Setting x5 to 800 at least keeps preview from getting stuck after x10 */
    [CROP_PRESET_3x3_1X_45p]    = { 1290, 1290, 1290, 1080, 1080, 800 }, /* 1080p45/48 Setting x5 to 800 at least keeps preview from getting stuck after x10 */
...
/* reset dummy reg in raw.c */
  ...
  else
  {
    switch (reg)
    {
        ...
        case 0xC0F06804: return ((timelapse == 0x1 || timelapse == 0x2 || timelapse == 0x3) && ratios != 0x3) ? 0xbde0412 + reg_6804_width + (reg_6804_height << 16): 0xa1c0412 + reg_6804_width + (reg_6804_height << 16); // 4032x2558  x5 Mode;
        ...
        case 0xC0F0713c: return ((timelapse == 0x1 || timelapse == 0x2 || timelapse == 0x3) && ratios != 0x3) ? 0xbde + reg_713c: 0xA1c + reg_713c;
        case 0xC0F07150: return ((timelapse == 0x1 || timelapse == 0x2 || timelapse == 0x3) && ratios != 0x3) ? 0xb5e + reg_7150 :0xa00 + reg_7150;
