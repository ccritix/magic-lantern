...
{
//	DryosDebugMsg(0, 15, "[adtg_log] skip_logging:  %d",skip_logging);
//	DryosDebugMsg(0, 15, "[adtg_log] photo_only:  %d, lv: %d",photo_only, lv);
//	bmp_printf(FONT_LARGE, 0, 140, "[adtg_log]  skip_logging:  %d",skip_logging);
//	bmp_printf(FONT_LARGE, 0, 240, "[adtg_log] photo_only:  %d, lv: %d",photo_only, lv);
...
{
//	DryosDebugMsg(0, 15, "[cmos_log] skip_logging:  %d",skip_logging);
//	DryosDebugMsg(0, 15, "[cmos_log] photo_only:  %d, lv: %d",photo_only, lv);
//	bmp_printf(FONT_LARGE, 0, 140, "[cmos_log]  skip_logging:  %d",skip_logging);
//	bmp_printf(FONT_LARGE, 0, 240, "[cmos_log] photo_only:  %d, lv: %d",photo_only, lv);
...
//        ENGIO_WRITE_FUNC = 0xFE29FBF0; // 0xfe29f7f0;//0xFE29FBF0;  // from stubs
//        ENG_DRV_OUT_FUNC = 0xFE29F844;
    } 	
