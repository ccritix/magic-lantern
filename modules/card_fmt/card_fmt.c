...
static unsigned int card_fmt_init()
{
    ...
    {
        addr_cf_check           = 0xff4f8914;
        addr_fat_or_exfat       = 0xff4f8b84;
        addr_fat_type_or_exfat  = 0xff758ccc;
        addr_partition_id       = 0xff758dcc;
        addr_exfat_table        = 0xffa4d8f0;
        addr_fat_table_1        = 0xffa4d8d8;
        addr_fat_table_2        = 0xffa4d88c;
        }
    else if (is_camera("EOSM",  "2.0.3"))
    {
        addr_cf_check           = 0xff4f89c4;
        addr_fat_or_exfat       = 0xff4f8c34;
        addr_fat_type_or_exfat  = 0xff758d80;
        addr_partition_id       = 0xff758e80;
        addr_exfat_table        = 0xffa4d9a0;
        addr_fat_table_1        = 0xffa4d988;
        addr_fat_table_2        = 0xffa4d93c;
    }
    else if (is_camera("550D",  "1.0.9"))
    {
        addr_fat_or_exfat       = 0xff386d38;
        addr_fat_type_or_exfat  = 0xff419148;
        addr_partition_id       = 0xff419248;
        addr_exfat_table        = 0xff53fc70;
        addr_fat_table_1        = 0xff53fc58;
        addr_fat_table_2        = 0xff53fc0c;
    }
    else if (is_camera("60D",  "1.1.2"))
    {
        addr_fat_or_exfat       = 0xff4050ec;
        addr_fat_type_or_exfat  = 0xff4f6404;
        addr_partition_id       = 0xff4f6504;
        addr_exfat_table        = 0xff65fe88;
        addr_fat_table_1        = 0xff65fe70;
        addr_fat_table_2        = 0xff65fe24;
    }
    else if (is_camera("100D",  "1.0.1"))
    {
        addr_fat_or_exfat       = 0xff4fb844;
        addr_fat_type_or_exfat  = 0xff77b7a4;
        addr_partition_id       = 0xff77b8a4;
        addr_exfat_table        = 0xffa80b1c;
        addr_fat_table_1        = 0xffa80b04;
        addr_fat_table_2        = 0xffa80ab8;
    }
