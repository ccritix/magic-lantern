...
if camera.model_short == "EOSM" then
  menu.set("Movie", "presets", "4K anamorphic rewired")
end
...
if menu.get("Movie", "presets", "") ~= "anamorphic" and menu.get("Movie", "presets", "") ~= "anamorphic rewired" and menu.get("Movie", "presets", "") ~= "4K anamorphic rewired" then
...
elseif camera.model_short == "5D3" then
 ...
 display.notify_box("4.5K anamorphic rewired is all set")
end
