 ...
 ###################################################################################
 #                                                                                 #
 #  USE ONLY WITH v1.1.0 FIRMWARE. I AM NOT RESPONSIBLE FOR ANYTHING THAT HAPPENS  #
 #  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  #
 #                                                                                 #
...
void toggle_bootdisk()
{
    ...
    if (*(int*)0xFFFF60D4 != 0xE52DE004 || *(int*)0xFFFF5FE4 != 0xE92D41F0)
    {
        while(1)
        {
            LEDRED = LEDON;
     ...
     *
     */
    read_bootflag = (ft_read_bootflag)0xFFFF60D4;
    write_bootflag = (ft_write_bootflag)0xFFFF5FE4;
