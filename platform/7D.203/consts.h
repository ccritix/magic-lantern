...
#define ROM_ITASK_START 0xff018734
#define ROM_ITASK_END  0xff01890c
#define ROM_CREATETASK_MAIN_START 0xff011f18
#define ROM_CREATETASK_MAIN_END 0xff0122f8
#define ROM_ALLOCMEM_END 0xff011f2c
#define ROM_ALLOCMEM_INIT 0xff011f34
#define ROM_B_CREATETASK_MAIN 0xff0187a8

// used in mem.c with CONFIG_RSCMGR_UNUSED_SPACE
#define RSCMGR_UNUSED_SPACE_START 0x5F800000
#define RSCMGR_UNUSED_SPACE_END   0x60000000
