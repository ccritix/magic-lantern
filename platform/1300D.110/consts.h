...
//#define ROM_ITASK_END  0xFE129760
#define ROM_CREATETASK_MAIN_START 0xFE0C1B60
//#define ROM_CREATETASK_MAIN_END 0xFE0C1DD4
#define ROM_CREATETASK_MAIN_END 0xFE0C1EB8
//#define ROM_CREATETASK_MAIN_END 0xFE0C3C9C
