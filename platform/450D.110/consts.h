...
#define DRYOS_ASSERT_HANDLER 0x11398 //+ 40D: 0xEF78  dec TH_assert or assert_0
...
// for gui_main_task
#define GMT_IDLEHANDLER_TASK (*(int*)0x2A78) //+ 40D: 0x2C10 dec create_idleHandler_task
...
#define CURRENT_GUI_MODE (*(int*)0x2A94) //+ 40D: 0x2A94
...
#define DIALOG_MnCardFormatExecute (0x56F8) // similar
    ...
    #define BFNT_CHAR_CODES    0xFF9AE288 //+ 40D: 0xff9ed308
    #define BFNT_BITMAP_OFFSET 0xFF9B022C //+ 40D: 0xff9ef4f8
    #define BFNT_BITMAP_DATA   0xFF9B21D0 //+ 40D: 0xff9f16e8    
...
// from CFn
    ...
    #define WINSYS_BMP_DIRTY_BIT_NEG MEM(0x4D9C) //+ 40D: 0x5C50 not sure
...
#define Q_BTN_NAME "Pict.Style"
    ...
    #define DISPLAY_IS_ON MEM(0xE250) //+ 40D: 0xBE9C guessed from TurnOffDisplay (PUB)
