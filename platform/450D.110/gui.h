...
#define BGMT_PRESS_LEFT 			53
#define BGMT_UNPRESS_LEFT 			54
#define BGMT_PRESS_UP 				55
#define BGMT_UNPRESS_UP 			56
#define BGMT_PRESS_RIGHT 			51
#define BGMT_UNPRESS_RIGHT 			52
#define BGMT_PRESS_DOWN 			57
#define BGMT_UNPRESS_DOWN 			58



// dummy
// #define BGMT_PRESS_FULLSHUTTER 		  -12345
// #define BGMT_UNPRESS_FULLSHUTTER 	  -12346

// #define BGMT_PRESS_HALFSHUTTER 		  0x0b
#define BGMT_PRESS_HALFSHUTTER 		  31
// #define BGMT_UNPRESS_HALFSHUTTER 	  32

#define BGMT_UNPRESS_SET			  -123456789

#define GMT_GUICMD_OPEN_SLOT_COVER	  0x28
#define GMT_GUICMD_START_AS_CHECK     -12345677
#define GMT_GUICMD_LOCK_OFF           -12345678

#define BGMT_Q                      BGMT_PRESS_DIRECT_PRINT
#define BGMT_LV                     -12345678
