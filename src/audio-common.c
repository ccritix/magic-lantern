...
static int audio_meters_step( int reconfig_audio )
{
    ...
    if(audio_meters_are_drawn())
    {
        ...
        else if(!reconfig_audio)
        {
            ...
            audio_configure(1);
            #elif defined(CONFIG_650D) || defined(CONFIG_700D) || defined(CONFIG_EOSM2)  || defined(CONFIG_EOSM)|| defined(CONFIG_100D) || defined(CONFIG_70D)
            void PowerMicAmp();
            PowerMicAmp(0);
            #endif
            reconfig_audio = 1;
...
static void audio_common_task(void * unused)
{
    ...
    #if defined(CONFIG_600D) || defined(CONFIG_650D) || defined(CONFIG_700D) || defined(CONFIG_EOSM2) || defined(CONFIG_EOSM) || defined(CONFIG_100D) || defined(CONFIG_70D)
