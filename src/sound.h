...
enum sound_source
{
    ...
    SOUND_SOURCE_OFF        = 1,
    SOUND_SOURCE_AUTO       = 2,
    SOUND_SOURCE_INT_MIC    = 3,
    SOUND_SOURCE_EXT_MIC    = 4,
    SOUND_SOURCE_HDMI       = 5,
...
enum sound_destination
{
    ...
    SOUND_DESTINATION_AUTO        = 2,
    SOUND_DESTINATION_SPK         = 3,
    SOUND_DESTINATION_LINE        = 4,
    SOUND_DESTINATION_AV          = 5,
    SOUND_DESTINATION_HDMI        = 6,
    SOUND_DESTINATION_EXTENDED_1  = 7,
    SOUND_DESTINATION_EXTENDED_2  = 8,
    SOUND_DESTINATION_EXTENDED_3  = 9,
    SOUND_DESTINATION_EXTENDED_4  = 10,
    SOUND_DESTINATION_EXTENDED_5  = 11,
    SOUND_DESTINATION_EXTENDED_6  = 12,
    SOUND_DESTINATION_MAX  = 12
};
